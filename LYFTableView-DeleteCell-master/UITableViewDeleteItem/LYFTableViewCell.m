...
-(void)setupCell {
    ...
    self.mainScrollView.frame = CGRectMake(100, 10, kScreenWidth -100, 40);
    self.backView.frame = CGRectMake(0, 0, kScreenWidth - 100, 40.f);
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (movePoint.x > [self deleteButtonWdith]) {
        self.deleteButton.frame = CGRectMake(kScreenWidth - 100, 0, movePoint.x, 40.f);
    } else {
        self.deleteButton.frame = CGRectMake(kScreenWidth - 100, 0, [self deleteButtonWdith], 40.f);
    }
}
